...
title: "Search for directions and estimated travel time between locations | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions#app-main)
...
## [URL](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#url)

```
GET https://maps-api.apple.com/v1/directions
```

## [Query Parameters](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#query-parameters)
...
You can specify only `arrivalDate` or `departureDate`. If you don’t specify either option, the `departureDate` defaults to _now_, which the server interprets as the current time.
...
See [`DirectionsAvoid`](https://developer.apple.com/documentation/applemapsserverapi/directionsavoid) for a complete list of possible values.
...
You can only specify `arrivalDate` or `departureDate`. If you don’t specify either option, the `departureDate` defaults to _now_, which the server interprets as the current time.
...
## [Response Codes](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#response-codes)
...
Returns a [`DirectionsResponse`](https://developer.apple.com/documentation/applemapsserverapi/directionsresponse) result that describes the steps and routes from the origin to the destination.
...
## [Discussion](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#Discussion)

### [Example](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#Example)
...
## [See Also](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#see-also)

### [Directions](https://developer.apple.com/documentation/applemapsserverapi/-v1-directions\#Directions)
...
Current page is Search for directions and estimated travel time between locations