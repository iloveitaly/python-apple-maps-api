...
| [`is_local_source_checkout`](#apple_maps_api.version.is_local_source_checkout)(→ bool)   | Check if the code is running from a local source checkout.     |
|------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| [`get_version`](#apple_maps_api.version.get_version)(→ str)                              | Get the version string, appending .dev if running from source. |
