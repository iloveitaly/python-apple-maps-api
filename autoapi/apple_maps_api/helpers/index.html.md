...
### apple_maps_api.helpers.geocode_postal_code(client: [apple_maps_api.client.AppleMapsClient](../client/index.html.md#apple_maps_api.client.AppleMapsClient), , postal_code: [str](https://docs.python.org/3/builtins/stdtypes.html#str), country: [str](https://docs.python.org/3/builtins/stdtypes.html#str) = 'US') → [apple_maps_api.models.GeocodeResult](../models/index.html.md#apple_maps_api.models.GeocodeResult) | [None](https://docs.python.org/3/builtins/constants.html#None)
...
### apple_maps_api.helpers.geocode_coordinates(client: [apple_maps_api.client.AppleMapsClient](../client/index.html.md#apple_maps_api.client.AppleMapsClient), , lat: [float](https://docs.python.org/3/builtins/functions.html#float), lon: [float](https://docs.python.org/3/builtins/functions.html#float)) → [apple_maps_api.models.GeocodeResult](../models/index.html.md#apple_maps_api.models.GeocodeResult) | [None](https://docs.python.org/3/builtins/constants.html#None)
